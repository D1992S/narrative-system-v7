...
Po zakończeniu utwórz niezmienny receipt narzędziem `New-K4VerifyReceipt.ps1`. Receipt wiąże cały raport, draft, bazę dowodów i aktywny korpus źródeł hashami SHA-256.
